#!/usr/bin/env python3
"""Repeatable host-side audit of the public 3Dvibe64 1.0 metric contract."""
...
def main() -> None:
    ...
    print("WORLD_METRICS_1_0 axes=pass depth=pass nearProfiles=default-late-clip ground=pass timing=pass")
